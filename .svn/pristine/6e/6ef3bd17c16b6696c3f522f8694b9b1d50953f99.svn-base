...
export default class MyBabyAdd extends Component {
    render() {
        return (
            <View style={PublicStyles.container}>
                ...
                <View style={[PublicStyles.bg_white,PublicStyles.ph15]}>
                    ...
                    <View style={PublicStyles.ju_between_Direction}>
                        <View style={[PublicStyles.ju_between_Direction,PublicStyles.al_center,PublicStyles.pv8,PublicStyles.listItem,PublicStyles.borderBottom]}>
                            ...
                            <View style={PublicStyles.ju_start_Direction}>
                                <TextInput
                                    style={PublicStyles.ft16_888}
                                    placeholder='2014-05-26'  // 输入框默认内容
                                    underlineColorAndroid='transparent'  // 安卓必写
                                />
                                <Image style={[PublicStyles.listMoreBtn,PublicStyles.mt4,PublicStyles.ml10]} source={require('../../img/more.png')} />
                            </View>
                    ...
                    <View style={PublicStyles.ju_between_Direction}>
                        <View style={[PublicStyles.ju_between_Direction,PublicStyles.al_center,PublicStyles.pv8,PublicStyles.listItem,PublicStyles.borderBottom]}>
                            <Text style={PublicStyles.ft16_333}>监护人姓名</Text>
                            <View style={PublicStyles.ju_start_Direction}>
                                <TextInput
                                    style={PublicStyles.ft16_888}
                                    placeholder='请输入宝宝监护人的真实姓名'  // 输入框默认内容
                                    underlineColorAndroid='transparent'  // 安卓必写
                                />
                                <Image style={[PublicStyles.listMoreBtn,PublicStyles.mt4,PublicStyles.ml10]} source={require('../../img/more.png')} />
                            </View>
                    ...
                    <View style={PublicStyles.ju_between_Direction}>
                        <View style={[PublicStyles.ju_between_Direction,PublicStyles.al_center,PublicStyles.pv8,PublicStyles.listItem,PublicStyles.borderBottom]}>
                            <Text style={PublicStyles.ft16_333}>家长手机号</Text>
                            <View style={PublicStyles.ju_start_Direction}>
                                <TextInput
                                    style={PublicStyles.ft16_888}
                                    placeholder='14200526526'  // 输入框默认内容
                                    underlineColorAndroid='transparent'  // 安卓必写
                                />
                                <Image style={[PublicStyles.listMoreBtn,PublicStyles.mt4,PublicStyles.ml10]} source={require('../../img/more.png')} />
                            </View>
                    ...
                    <View style={PublicStyles.ju_between_Direction}>
                        <View style={[PublicStyles.ju_between_Direction,PublicStyles.al_center,PublicStyles.pv8,PublicStyles.listItem,PublicStyles.borderBottom]}>
                            <Text style={PublicStyles.ft16_333}>家庭住址</Text>
                            <View style={PublicStyles.ju_start_Direction}>
                                <TextInput
                                    style={PublicStyles.ft16_888}
                                    placeholder='请输入家庭住址'  // 输入框默认内容
                                    underlineColorAndroid='transparent'  // 安卓必写
                                />
                                <Image style={[PublicStyles.listMoreBtn,PublicStyles.mt4,PublicStyles.ml10]} source={require('../../img/more.png')} />
                            </View>
                ...
                <View style={PublicStyles.ph15}>
                    <View style={[PublicStyles.courseIntroTitle,PublicStyles.bg_green,PublicStyles.al_center,PublicStyles.ju_center,PublicStyles.mt24,PublicStyles.borderRadius]}>
                        <Text style={PublicStyles.ft16_fff}>确认</Text>
                    </View>
                </View>
            </View>
        );
