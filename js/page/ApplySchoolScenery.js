...
export default class ApplySchoolScenery extends Component {
    render() {
        return (
            <View style={PublicStyles.container}>
                <View style={PublicStyles.banner}>
                    <Image style={PublicStyles.banner} source={require('../../img/ClassBanner-3.png')} />
                </View>
                ...
                <View style={[PublicStyles.bg_white,PublicStyles.ph15]}>
                    <View style={[PublicStyles.ju_start_Direction,PublicStyles.al_center,PublicStyles.listTitle,PublicStyles.borderBottom]}>
                        <Text style={[PublicStyles.listTitleName,PublicStyles.ft16_333]}>报名费：</Text>
                        <Text style={PublicStyles.ft16_333}>3200.00元 / 期</Text>
                    </View>
                    <View style={[PublicStyles.ju_start_Direction,PublicStyles.al_center,PublicStyles.listTitle,PublicStyles.borderBottom]}>
                        <Text style={[PublicStyles.listTitleName,PublicStyles.ft16_333]}>其他费：</Text>
                        <Text style={PublicStyles.ft16_333}>1000.00元 / 2身</Text>
                    </View>
                    <View style={[PublicStyles.ju_start_Direction,PublicStyles.al_center,PublicStyles.listTitle,PublicStyles.borderBottom]}>
                        <Text style={[PublicStyles.listTitleName,PublicStyles.ft16_333]}>帐篷：</Text>
